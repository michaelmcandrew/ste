...
class DeclarationTest extends CiviUnitTestCase
{
    ...
    public function dataProvider()
    {
        return 
            array(
                  ...
                  array( 'ip' => array( 1, 1, '2010-01-01', null ), // input => cid, eligible, start-date, end-date
                         'op' => array( array ( 1, 1, '2010-01-01 00:00:00', '2013-01-01 00:00:00' ) ) // output 
                         ),

                  // 01-jun-10 user makes contrib, says yes
                  array( 'ip' => array( 1, 1, '2010-06-01', null ), // input
                         'op' => array( array ( 1, 1, '2010-01-01 00:00:00', '2013-06-01 00:00:00' ) ) // output
                         ),

                  // 01-jan-11 user makes contrib, says no
                  array( 'ip' => array( 1, 0, '2011-01-11', null ), // input
                         'op' => array( array ( 1, 1, '2010-01-01 00:00:00', '2011-01-11 00:00:00' ), // output row1
                                        array ( 1, 0, '2011-01-11 00:00:00', null                  ) ) // output row2
                         ),

                  // 01-jun-11 user makes contrib, says no
                  array( 'ip' => array( 1, 0, '2011-06-11', null ), // input
                         'op' => array( array ( 1, 1, '2010-01-01 00:00:00', '2011-01-11 00:00:00' ), // output row1
                                        array ( 1, 0, '2011-01-11 00:00:00', null                  ) ) // output row2
                         ),

                  // 01-jan-12 user sets up monthly regular contrib, says yes
                  array( 'ip' => array( 1, 1, '2012-01-01', null ), // input
                         'op' => array( array ( 1, 1, '2010-01-01 00:00:00', '2011-01-11 00:00:00' ), // output row1
                                        array ( 1, 0, '2011-01-11 00:00:00', '2012-01-01 00:00:00' ),
                                        array ( 1, 1, '2012-01-01 00:00:00', '2015-01-01 00:00:00' ) ) // output row2
                         ),
                  );
    }
    ...
    {
        $count = 0; $params = $tableRows = array( );
