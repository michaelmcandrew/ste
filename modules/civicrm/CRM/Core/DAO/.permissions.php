...
function _civicrm_api3_permissions($entity, $action, &$params)
{
    ...
    $permissions = array(
        'activity' => array(
            'delete' => array('access CiviCRM', 'delete activities'),
            'get'    => array('access CiviCRM', 'view all activities'),
        ),
        'address' => array(
        ...
        'contribution' => array(
            ...
            'delete' => array('access CiviCRM', 'access CiviContribute', 'delete in CiviContribute'),
            'get'    => array('access CiviCRM', 'access CiviContribute'),
            'update' => array('access CiviCRM', 'access CiviContribute', 'edit contributions'),
        ),
        'custom_field' => array(
        ...
        'event' => array(
            'create' => array('access CiviCRM', 'access CiviEvent', 'edit all events'),
            'delete' => array('access CiviCRM', 'access CiviEvent', 'delete in CiviEvent'),
            'get'    => array('access CiviCRM', 'access CiviEvent', 'view event info'),
            'update' => array('access CiviCRM', 'access CiviEvent', 'edit all events'),
        ),
        'file' => array(
            'create' => array('access CiviCRM', 'access uploaded files'),
            'delete' => array('access CiviCRM', 'access uploaded files'),
            'get'    => array('access CiviCRM', 'access uploaded files'),
            'update' => array('access CiviCRM', 'access uploaded files'),
        ),
        ...
        'group' => array(
            'create' => array('access CiviCRM', 'edit groups'),
            'delete' => array('access CiviCRM', 'edit groups'),
            'update' => array('access CiviCRM', 'edit groups'),
        ),
        'group_contact' => array(
            'create' => array('access CiviCRM', 'edit groups'),
            'delete' => array('access CiviCRM', 'edit groups'),
