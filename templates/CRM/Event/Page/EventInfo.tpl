	...
	<div class="section event_date_time-section">
	    ...
	    <div class="content">
            ...
            {if $event.event_end_date}
				...
				{if $event.event_end_date|date_format:"%A%e%B%Y" ==
$event.event_start_date|date_format:"%A%e%B%Y"}
                <!--
                {if $event.event_end_date|date_format:"%Y%m%d" ==
                $event.event_start_date|date_format:"%Y%m%d"}-->
