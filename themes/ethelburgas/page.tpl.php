...
<?php if (substr($node->path, 0, 7)!='gallery') : ?>
	...
	<?php endif; ?>
      ...
      </div></div><div style="clear:both;"></div></div> <!-- /.left-corner, /.right-corner, /#squeeze, /#center -->
                <div id="footer"><div id="footer-message"><?php print $footer_message ?> </div><?php print theme('links', $secondary_links, array('class' => 'links secondary-links'))?> 
</div>
